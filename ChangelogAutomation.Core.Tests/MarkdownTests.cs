// SPDX-FileCopyrightText: 2021-2025 ChangelogAutomation contributors <https://github.com/ForNeVeR/ChangelogAutomation>
//
...
public sealed class Tests
{
    ...
    [Test]
    public Task SimpleExtractionTest() => ExtractionTest(
        """
        # Changelog
        ## 2.0
        - Foo
    ...
    [Test]
    public Task InlineLinkTest() => ExtractionTest(
        """
        # Changelog
        ## 2.0
    ...
    [Test]
    public Task LinkReferenceExtractionTest() => ExtractionTest(
        """
        # Changelog
        ## 2.0
        - [Foo][link]
    ...
    [Test]
    public Task LinkBlockIgnoreTest() => ExtractionTest(
        """
        # Changelog
        ## 1.0
        - [Bar][link]
    ...
    [Test]
    public Task MultipleLinksToTheSameTest() => ExtractionTest(
        """
        # Changelog
        ## 1.0
        - [Bar][link]
